...
- Tool registry designed for the future "capability request loop" — Aerys requests a new capability, the development toolchain builds it, registers it via INSERT, no Core Agent edits required
